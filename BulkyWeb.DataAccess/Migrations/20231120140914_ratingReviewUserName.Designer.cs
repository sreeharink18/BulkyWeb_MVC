...
namespace BulkyWeb.DataAccess.Migrations
{
    ...
    [Migration("20231120140914_ratingReviewUserName")]
    partial class ratingReviewUserName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyWeb.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyWeb.Models.Product", b =>
                {
                    ...
                    b.Property<string>("IsDiscountProduct")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("TotalBooktCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyWeb.Models.RatingReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyWeb.Models.SalesReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyWeb.Models.RatingReview", b =>
                {
                    b.HasOne("BulkyWeb.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");
